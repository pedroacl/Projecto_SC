...
/**
 * Classe que representa um mensagem de Chat, isto é uma mensagem entre
 * utilizadores
 * 
...
public class ChatMessage implements Serializable {
	...
	/**
	 * Getter para data de criaçao da mensagem
	 * 
	 ...
	 * 
	 * @param createdAt
	 *            Data que representa a data de criaçao da mensagem
	 */
	...
	public boolean equals(Object obj) {
		...
		return chatMessage.content.equals(this.content) && chatMessage.fromUser.equals(this.fromUser)
				&& chatMessage.destination.equals(this.destination) && chatMessage.type.equals(this.type)
